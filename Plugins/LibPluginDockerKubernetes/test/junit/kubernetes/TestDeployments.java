...
public class TestDeployments {
	...
	@Test
	public void test01PatchDeploy() {
		try {
			String content = "{\"spec\": {\"replicas\": 1}}";
			String namespace = "default";
			String name = "agentaggregator";
			...
			params.put("DEPLOYMENT", name);

			LOGD("== PATCH DEPLOY " + name + " @ " + namespace);
			LOGD("PATCH PAYLOAD: " + content);
			
			JSONObject root =  (JSONObject)client.invoke(dest, "PatchDeployment", params);
			...
			LOGD("PATCH DEPLOYMENT RESPONSE: " + root);
