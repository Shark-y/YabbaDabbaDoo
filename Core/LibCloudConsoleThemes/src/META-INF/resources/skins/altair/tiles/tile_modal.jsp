...
%>
	...
	function modalSetTitle (text) {
		...
		<div id="<%=modalId%>" class="modal fade uk-modal" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog uk-modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer uk-modal-footer uk-text-right">
						<button type="button" class="btn btn-default md-btn md-btn-flat uk-modal-close" data-dismiss="modal">Close</button>
						<button type="submit" class="btn btn-raised btn-primary md-btn md-btn-primary" onclick="return ed_btn1_click()"><%=btn1Label%></button>
					</div>
					<% } %>
				</div>
			</div>
