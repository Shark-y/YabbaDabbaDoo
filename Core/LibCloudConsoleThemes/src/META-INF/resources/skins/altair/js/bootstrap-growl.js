...
;(function ( $, window, document, undefined ) {
	...
	var pluginName = "growl",
		...
		defaults = {
			...
			onHidden: null,
			icon_type: 'class',
			template: '<div data-growl="container" class="uk-alert" role="alert"><button type="button" aria-hidden="true" class="uk-alert-close uk-close" data-growl="dismiss"></button><span data-growl="icon"></span><span data-growl="title"></span><span data-growl="message"></span><a href="#" data-growl="url"></a></div>'
		};
	...
	buildGrowl = function(base) {
		...
		$template.addClass('uk-alert-' + base.settings.type);
