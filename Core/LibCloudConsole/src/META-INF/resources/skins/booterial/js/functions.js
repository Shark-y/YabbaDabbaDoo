...
$(document).ready(function(){
    ...
    (function () {
		...
		// vsilva set skin
		var skin = localStorage.getItem('data-current-skin');
		if ( skin) $('[data-current-skin]').attr('data-current-skin', skin)
	...
	*/
    ...
    (function(){
        //Toggle
        $('body').on('click', '#menu-trigger', function(e){ //, #chat-trigger
            e.preventDefault();
